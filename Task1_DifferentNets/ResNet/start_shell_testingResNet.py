...
dataSets    = ["octmnist", "pneumoniamnist", "pathmnist", "chestmnist","retinamnist", "dermamnist", 
"breastmnist" ,"organmnist_coronal", "organmnist_sagittal", "organmnist_axial"]

for dset in range(len(dataSets)):
    for slc in slices:
        os.system('python testingResNet.py '+
        '--data_name ' + str(dataSets[dset]) + ' ' +
        '--dataset_root ../../../DataSets/medmnist/ ' +
        '--model_root ../../../TrainedNets/Training_Resnet18_self/ ' +
        '--train_size ' + str(slc) + ' ' +
        '--download False '
        )